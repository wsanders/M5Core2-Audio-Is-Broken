...
const int stations = 2;// Change Number here if you add feeds!
char * stationList[stations][2] = {
  {"Dismuke", "http://stream1.early1900s.org:8080"},
  {"TMX", "http://streams.kut.org/4430_192.mp3?aw_0_1st.playerid=tmx-free"},
};
...
void setup() {
  ...
  // 3: Green light on top, USB on right, breaks buttons

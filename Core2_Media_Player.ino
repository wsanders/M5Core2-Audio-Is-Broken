...
const int stations = 3;// Change Number here if you add feeds!
char * stationList[stations][2] = {
  {"Dismuke", "http://stream1.early1900s.org:8080"},
  {"TMX 192", "http://streams.kut.org/4430_192.mp3?aw_0_1st.playerid=tmx-free"},
};
...
void playMP3() {
  ...
  // Irrelevant outmp3->SetBitsPerSample(16 vs 8);
  ...
  // StreamTitle
  buffmp3 = new AudioFileSourceBuffer(filemp3, preallocateBuffer, preallocateBufferSize);
